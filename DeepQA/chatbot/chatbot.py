...
#        self.MODEL_DIR_BASE = 'save' + os.sep + 'model'
        self.MODEL_DIR_BASE = 'save' + os.sep + 'model-RespondForTest02'
#        self.MODEL_NAME_BASE = 'model'
        self.MODEL_NAME_BASE = 'model-RespondForTest02'
        self.MODEL_EXT = '.ckpt'
        self.CONFIG_FILENAME = 'params.ini'
        self.CONFIG_VERSION = '0.5'
        self.TEST_IN_NAME = 'data' + os.sep + 'test' + os.sep + 'RespondForTest02.txt' 
        """改samples.txt"""
