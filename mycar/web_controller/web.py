...
class LocalWebController(tornado.web.Application):
    ...
    def run_chaos(self, img_arr=None, str_ang=None):
        """
    ...
    def _run_threaded(self, img_arr=None, str_ang=None, thr_amp=None):
#    def _run_threaded(self, img_arr=None, str_ang=None):
#    def _run_threaded(self, img_arr=None, str_ang=None):
        self.img_arr = img_arr
        self.angle = str_ang
        self.throttle = thr_amp
#        self.cnt += 1
#        if self.cnt == 5:
#            print ('Web_thread_steering/throttle: {:.1f}/{:.1f}'.format(self.angle, self.throttle))
...
#    def run(self, img_arr=None, str_ang=None, thr_amp=None):
    def run(self, img_arr=None, str_ang=None):
        self.angle = str_ang
#        self.throttle = thr_amp
#        print ('Web_run_steering/throttle: {:.1f}/{:.1f}'.format(self.angle, self.throttle))
        print ('Web_run_steering: {:.1f}'.format(self.angle))
#        return self.run_threaded(img_arr, self.angle, self.throttle)
        return self.run_threaded(img_arr, self.angle)
