...
class Chatbot:
    ...
    def __init__(self):
        ...
        self.MODEL_DIR_BASE = 'save/model-AIA'
        self.MODEL_NAME_BASE = 'model-AIA'
        self.MODEL_EXT = '.ckpt'
        self.CONFIG_FILENAME = 'params.ini'
        self.CONFIG_VERSION = '0.5'
        self.TEST_IN_NAME = 'data/test/RespondForTest02.txt'
    ...
    def loadEmbedding(self, sess):
        ...
        with tf.variable_scope("embedding_rnn_seq2seq/rnn/embedding_wrapper", reuse=True): # orig : reuse = True
            em_in = tf.get_variable("embedding")
        with tf.variable_scope("embedding_rnn_seq2seq/embedding_rnn_decoder", reuse=True): #orig : reuse = True
